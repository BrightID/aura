...
export const input: ComponentDoc = {
  ...
  props: [
    ...
    { name: "value", type: "string", default: "", description: "Current value (reflected)." },
    { name: "name", type: "string", default: "input-text", description: "Form field name." },
    { name: "disabled", type: "boolean", default: false, description: "Disables the field." },
  ],
  cssVars: [
    { name: "--input", default: "oklch(0.20 0.015 265)", description: "Input surface color." },
    { name: "--border", default: "oklch(0.27 0.018 265)", description: "Border color." },
    {
