...
export const card: ComponentDoc = {
  ...
  cssVars: [
    { name: "--card", default: "oklch(0.16 0.015 265)", description: "Base card surface color." },
    { name: "--card-bg", default: "var(--card)", description: "Override for the card background." },
    {
      name: "--card-border",
    ...
    { name: "--blur", default: "2px", description: "Backdrop blur amount (glass variant)." },
  ],
};
