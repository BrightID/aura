...
/** Minimal inline renderer: turns `code` spans in a plain string into <code>. */
...
export default async function ComponentPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="prose">
      ...
      <p>
        These CSS custom properties are inherited from <code>&lt;a-theme-provider&gt;</code>. Override
        them on any ancestor — or live in the <strong>Theme</strong> tab above — to restyle the
        component.
      </p>
      <div className="not-prose">
        <CssVarTable doc={doc} />
