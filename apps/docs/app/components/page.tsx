  ...
  return (
    <div className="prose">
      ...
      <p className="prose-lead">
        Aura&apos;s UI kit is a set of framework-agnostic web components. Every component below has a
        live playground — tweak its props and theme variables, then copy the generated markup.
      </p>
