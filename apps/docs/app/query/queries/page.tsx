...
export const metadata: Metadata = {
  ...
  description:
    'Fetch, cache, and reactively render server data in Lit components.',
};
  ...
  return (
    <article className="prose">
      ...
      <p className="prose-lead">
        <code>Query</code> is a Lit <code>ReactiveController</code> that fetches
        data, caches it, and keeps your component in sync — automatically
  ...
  render() {
    ...
    \`
      ...
      <Table
        ...
        rows={[
          [
            ...
            'Overall query lifecycle state.',
          ],
          [
            <code key="c">fetchStatus</code>,
            <code key="d">&quot;fetching&quot; | &quot;idle&quot;</code>,
            'Whether a network request is currently in flight.',
          ],
          [
            <code key="e">data</code>,
            'TData | undefined',
            'The resolved data, or undefined while pending.',
          ],
          [
            <code key="f">error</code>,
            'TError | null',
          ...
          [
            <code key="j">isFetching</code>,
            'boolean',
            "fetchStatus === 'fetching'",
          ],
          [
            <code key="k">isLoading</code>,
            'boolean',
            'isPending && isFetching — first-load indicator.',
          ],
        ]}
      />
      ...
      <Table
        ...
        rows={[
          [
            <code key="a">queryKey</code>,
            'unknown[]',
            '—',
            'Unique cache key. Change it to re-fetch different data.',
          ],
          [
            <code key="b">queryFn</code>,
            '(ctx) => Promise<TData>',
            '—',
            'Async function that returns data. Receives { queryKey, signal }.',
          ],
          [
            <code key="c">staleTime</code>,
            'number (ms)',
            'client default (0)',
            'Data freshness window. While fresh, no background refetch.',
          ],
          [
            <code key="d">gcTime</code>,
            'number (ms)',
            'client default (5 min)',
            'How long inactive entries stay in cache.',
          ],
          [
            <code key="e">enabled</code>,
            'boolean',
            'true',
            'Set false to skip fetching (e.g. wait for auth).',
          ],
          [
          ...
          [
            ...
            'TData | (prev) => TData',
            '—',
            'Data to show while first load is in flight.',
          ],
          [
            <code key="k">client</code>,
            'QueryClient',
            'defaultClient',
            'The cache instance to use.',
          ],
          [
            <code key="l">onSuccess</code>,
            '(data) => void',
            '—',
            'Called after a successful fetch.',
          ],
          [
            <code key="m">onError</code>,
            '(error) => void',
            '—',
            'Called after all retries are exhausted.',
          ],
          [
            <code key="n">onSettled</code>,
            '(data, error) => void',
            '—',
      ...
      <p>
        ...
        <code>updateOptions</code> inside <code>updated()</code>. The controller
        detects the key change, re-subscribes, and fetches fresh data
        automatically.
      </p>
