...
import { encryptData } from '@/features/brightid/utils/cryptoHelper';
import { b64ToUrlSafeB64 } from '@/features/brightid/utils/encoding';
...
export const getUserInfo = async (
  ...
  try {
    ...
    if (response.ok) {
      ...
      const { decryptData: decryptFn } = await import('@/features/brightid/utils/cryptoHelper');
