...
export const createRouter = (
  ...
  const routerValue = new Router(classThis, [
    ...
    },
    {
      ...
      render: ({ id }) =>
        html`<app-layout>
          <project-landing .projectId=${Number(id)}></project-landing
        ></app-layout>`,
    },
    {
      ...
      render: () =>
        html` <app-layout> <complete-profile></complete-profile></app-layout>`,
    },
    {
      path: '/interface/home',
      enter: async () => {
      ...
      render: () =>
        html`<app-layout>
          <my-home></my-home> <app-footer></app-footer>
        </app-layout> `,
    },
    {
      ...
      render: ({ id }) =>
        html`<app-layout>
          <verification-page .projectId=${Number(id)}></verification-page>
    ...
    },
    {
      ...
      render: () =>
        html`<app-layout>
          <share-page></share-page> <app-footer></app-footer>
        </app-layout> `,
    },
    {
      ...
      render: () =>
        html`<app-layout> <privacy-policy></privacy-policy> </app-layout> `,
    },
    {
      path: '/interface/dev',
      enter: async () => {
    ...
    },
    {
      ...
      render: () =>
        html`<app-layout>
          <profile-page></profile-page> <app-footer></app-footer>
        </app-layout> `,
    },
    {
      ...
      render: () =>
        html`<app-layout> <brightid-login></brightid-login></app-layout>`,
    },
    {
