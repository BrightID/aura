...
<section id="faq" use:scrollReveal class="py-24 lg:py-32 relative overflow-hidden">
  <div class="absolute inset-0 bg-[radial-gradient(45%_50%_at_50%_0%,rgba(34,211,238,0.07),transparent_70%)]"></div>

  <div class="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16">
      <span class="font-mono text-primary text-xs uppercase tracking-[0.25em]">FAQ</span>
