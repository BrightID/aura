    ...
    return html`
      ...
      <a-popover side="bottom" align="start">
        ...
        <div slot="content" class="panel">
          <div class="sv" style="--hue: ${this._h}" @pointerdown=${this._onSvPointerDown}>
            <div class="sv-thumb" style="left: ${this._s}%; top: ${100 - this._v}%;"></div>
          </div>
          <div class="hue" @pointerdown=${this._onHuePointerDown}>
            <div class="hue-thumb" style="left: ${(this._h / 360) * 100}%;"></div>
          </div>
          <input
            class="text-input"
            spellcheck="false"
