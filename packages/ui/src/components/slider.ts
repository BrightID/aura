...
export class SliderElement extends LitElement {
  ...
  @query(".track") private declare _track: HTMLElement
  ...
  private _onPointerDown = (e: PointerEvent) => {
    ...
    this.renderRoot.querySelector(".track")?.addEventListener(
      "pointermove",
  ...
  private _onPointerUp = () => {
    ...
    this.renderRoot.querySelector(".track")?.removeEventListener(
      "pointermove",
      this._onPointerMove as EventListener,
    )
  }
